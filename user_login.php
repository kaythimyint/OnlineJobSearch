    ...
    <section>
        <div class="row flex-column-reverse flex-lg-row m-0">
            <div class="col-12 col-lg-5 d-flex justify-content-center align-items-start align-items-lg-center min-vh-lg-100"
                ...
                <form action="" style="width:80%;margin:auto;padding-top:20px" class="user_login" method="post">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex border border-info rounded">
                                        ...
                                        <input type="email" class="form-control" name="email" style="background-color: inherit;border:none" id="email" placeholder="User Email">
                                    </div>
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <div class="d-flex border border-info rounded">
                                        ...
                                        <input type="password" class="form-control" name="password" style="background-color: inherit;border:none" id="email" placeholder="Enter Password">
                                    </div>
                                    <small id="emailHelp" class="form-text text-danger">Email Invalid</small>
                                </div>
                                <input type="hidden" name="form_submit" value="user" />
                                ...
                                <div class="d-flex justify-content-center mt-5">
                                    ...
                                    <a href="<?php echo $base_url . "user_register.php" ?>" style="color: gold;text-decoration:none"> Create an account</a>
                                </div>
                            </form>
            </div>
