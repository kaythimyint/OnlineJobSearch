...
if ($delete_id != '') {
    $deleteRes = deleteData('experience',$mysqli,"WHERE id = '$delete_id'");
    if ($deleteRes) {
        $url = $admin_base_url.'experience.php?success=Delete Success';
        header("Location:$url");
        exit();
    }
}
...
?>
        <div class="col-12 col-md-9">
           <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                <a href="<?= $admin_base_url."experience_create.php" ?>" class="btn btn-primary btn-lg">Create</a>
           </div>
           <div class="card">
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="<?= $admin_base_url.'experience_update.php?id=' . $items['id'] ?>" class="btn btn-info mb-2">Update</a>
        ...
        $('.delete_btn').click(function(){
            ...
            confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'experience.php?delete_id=' + id;
                }
            });
        });
    });
