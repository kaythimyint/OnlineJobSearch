...
if ($delete_id != '') {
    $deleteRes = deleteData('location_township',$mysqli,"WHERE id = '$delete_id'");
    if ($deleteRes) {
        $url = $admin_base_url.'location_township.php?success=Delete Success';
        header("Location:$url");
        exit();
    }
}
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="col-3">Township Name</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="<?= $admin_base_url.'location_township_update.php?id=' . $items['id'] ?>" class="btn btn-info mb-2">Update</a>
        ...
        $('.delete_btn').click(function(){
            ...
            confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = 'location_township.php?delete_id=' + id;
                }
            });
        });
    });
